...
/**!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 * Note: in a real-world example, the amount should be checked on the backend side
 * and the list of dishes related to the command should be stored in a more specific
 * Content Type called orderDetail.
 *
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 *
 * Order.js controller
...
const stripe = require('stripe')('sk_test_NMDLTYbgkpSsUe1EyX27nDDC');
